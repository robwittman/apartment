...
namespace Test\Apartment\Migration;
...
class ManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        // stub environment
        $envStub = $this->getMockBuilder('\Apartment\Migration\Manager\Environment')
    ...
    public function testGetMigrationsWithClassThatDoesntExtendAbstractMigration()
    {
        $this->setExpectedException(
            'InvalidArgumentException',
            'The class "InvalidSuperClass" in file "' . $this->getCorrectedPath(__DIR__ . '/_files/invalidsuperclass/20120111235330_invalid_super_class.php') . '" must extend \Apartment\Migration\AbstractMigration'
        );
    ...
    public function testGetMigrationsWithClassThatDoesntExtendAbstractMigrationWithNamespace()
    {
        $this->setExpectedException(
            'InvalidArgumentException',
            'The class "Foo\Bar\InvalidSuperClass" in file "' . $this->getCorrectedPath(__DIR__ . '/_files_foo_bar/invalidsuperclass/20160111235330_invalid_super_class.php') . '" must extend \Apartment\Migration\AbstractMigration'
        );
    ...
    public function testRollbackToVersionByExecutionTime($availableRollbacks, $version, $expectedOutput)
    {
        ...
        $configArray = $this->getConfigArray();
        $configArray['version_order'] = \Apartment\Config\Config::VERSION_ORDER_EXECUTION_TIME;
        $config = new Config($configArray);
        $this->input = new ArrayInput([]);
        $this->output = new StreamOutput(fopen('php://memory', 'a', false));
        $this->output->setDecorated(false);
        ...
        return [
            ...
            'Rollback to last migration with creation time version ordering - no breakpoints set' =>
                [
                    ...
                    \Apartment\Config\Config::VERSION_ORDER_CREATION_TIME,
                    '== 20120116183504 TestMigration2: reverted'
                ],
            ...
            'Rollback to last migration with execution time version ordering - no breakpoints set' =>
                [
                    ...
                    \Apartment\Config\Config::VERSION_ORDER_EXECUTION_TIME,
                    '== 20120111235330 TestMigration: reverted'
                ],
    ...
    public function testReversibleMigrationsWorkAsExpected()
    {
        ...
        $adapter->dropDatabase(TESTS_Apartment_DB_ADAPTER_MYSQL_DATABASE);
        $adapter->createDatabase(TESTS_Apartment_DB_ADAPTER_MYSQL_DATABASE);
        $adapter->disconnect();
