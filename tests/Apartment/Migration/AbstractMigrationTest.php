...
class AbstractMigrationTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        // stub migration
        $migrationStub = $this->getMockForAbstractClass('\Apartment\Migration\AbstractMigration', [0]);
    ...
    public function testGetInputMethodWithInjectedInput()
    {
        ...
        // stub migration
        $migrationStub = $this->getMockForAbstractClass('\Apartment\Migration\AbstractMigration', [0, $inputStub, null]);
    ...
    public function testGetOutputMethodWithInjectedOutput()
    {
        ...
        // stub migration
        $migrationStub = $this->getMockForAbstractClass('\Apartment\Migration\AbstractMigration', [0, null, $outputStub]);
    ...
    {
        $migrationStub = $this->getMockForAbstractClass('\Apartment\Migration\AbstractMigration', [20120103080000]);
