...
class PdoAdapterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->adapter = $this->getMockForAbstractClass('\Apartment\Db\Adapter\PdoAdapter', [['foo' => 'bar']]);
    }
    ...
    {
        $this->assertEquals('Apartmentlog', $this->adapter->getSchemaTableName());
    ...
    public function testGetVersionLog($versionOrder, $expectedOrderBy)
    {
        $adapter = $this->getMockForAbstractClass(
            '\Apartment\Db\Adapter\PdoAdapter',
    ...
    public function getVersionLogDataProvider()
    {
        return [
            'With Creation Time Version Order' => [
                \Apartment\Config\Config::VERSION_ORDER_CREATION_TIME, 'version ASC'
            ],
            'With Execution Time Version Order' => [
                \Apartment\Config\Config::VERSION_ORDER_EXECUTION_TIME, 'start_time ASC, version ASC'
            ],
        ];
    }
