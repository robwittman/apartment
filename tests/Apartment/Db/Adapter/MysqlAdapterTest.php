...
use Apartment\Db\Adapter\AdapterInterface;
...
{
    /**
     * @var \Apartment\Db\Adapter\MysqlAdapter
     */
    private $adapter;
    ...
    public function setUp()
    {
        ...
        $options = [
            'host' => TESTS_Apartment_DB_ADAPTER_MYSQL_HOST,
            'name' => TESTS_Apartment_DB_ADAPTER_MYSQL_DATABASE,
            'user' => TESTS_Apartment_DB_ADAPTER_MYSQL_USERNAME,
            'pass' => TESTS_Apartment_DB_ADAPTER_MYSQL_PASSWORD,
            'port' => TESTS_Apartment_DB_ADAPTER_MYSQL_PORT
        ];
    ...
    {
        if (!TESTS_Apartment_DB_ADAPTER_MYSQL_UNIX_SOCKET) {
            $this->markTestSkipped('MySQL socket connection skipped. See TESTS_Apartment_DB_ADAPTER_MYSQL_UNIX_SOCKET constant.');
        }
        ...
        $options = [
            ...
            'user' => TESTS_Apartment_DB_ADAPTER_MYSQL_USERNAME,
            'pass' => TESTS_Apartment_DB_ADAPTER_MYSQL_PASSWORD,
            'unix_socket' => TESTS_Apartment_DB_ADAPTER_MYSQL_UNIX_SOCKET,
        ];
    ...
    public function testCreateTableWithComment()
    {
        ...
        $rows = $this->adapter->fetchAll(sprintf(
            ...
            TESTS_Apartment_DB_ADAPTER_MYSQL_DATABASE
        ));
        $comment = $rows[0];
    ...
    {
        $tag_table = new \Apartment\Db\Table('ntable_tag', [], $this->adapter);
    ...
    {
        $table = new \Apartment\Db\Table('table1', ['engine' => 'MyISAM'], $this->adapter);
        $table->addColumn('email', 'string')
    ...
    {
        $table = new \Apartment\Db\Table('ntable', ['engine' => 'MyISAM'], $this->adapter);
        $table->addColumn('realname', 'string')
              ->save();
        $this->assertTrue($this->adapter->hasTable('ntable'));
    ...
    {
        $table = new \Apartment\Db\Table('latin1_table', ['collation' => 'latin1_general_ci'], $this->adapter);
    ...
    {
        $table = new \Apartment\Db\Table('ntable', ['signed' => false], $this->adapter);
        $table->addColumn('realname', 'string')
              ->addColumn('email', 'integer')
              ->save();
        $this->assertTrue($this->adapter->hasTable('ntable'));
    ...
    {
        $table = new \Apartment\Db\Table('table_custom_collation', ['collation' => 'utf8_general_ci'], $this->adapter);
        $table->save();
    ...
    public function testDescribeTable()
    {
        ...
        $this->assertEquals($described['TABLE_SCHEMA'], TESTS_Apartment_DB_ADAPTER_MYSQL_DATABASE);
        $this->assertEquals($described['TABLE_ROWS'], 0);
    }

    public function testGetColumnsReservedTableName()
    {
        $table = new \Apartment\Db\Table('group', [], $this->adapter);
        $table->addColumn('column1', 'string')
              ->addColumn('column2', 'integer')
              ->addColumn('column3', 'biginteger')
              ->addColumn('column4', 'text')
    ...
    public function testDropIndex()
    {
        ...
        $table2 = new \Apartment\Db\Table('table5', [], $this->adapter);
        $table2->addColumn('fname', 'string')
               ->addColumn('lname', 'string')
               ->addIndex(['fname', 'lname'])
               ->save();
        ...
        // single column
        $table4 = new \Apartment\Db\Table('table6', [], $this->adapter);
        $table4->addColumn('fname', 'string')
               ->addColumn('lname', 'string')
               ->addIndex(['fname', 'lname'], ['name' => 'multiname'])
               ->save();
    ...
    {
        $refTable = new \Apartment\Db\Table('ref_table', ['signed' => false], $this->adapter);
        $refTable->addColumn('field1', 'string')->save();
    ...
    public function testHasDatabase()
    {
        ...
        $this->assertTrue($this->adapter->hasDatabase(TESTS_Apartment_DB_ADAPTER_MYSQL_DATABASE));
    }
    ...
    public function testEnumColumnValuesFilledUpFromSchema()
    {
        ...
        (new \Apartment\Db\Table('table1', [], $this->adapter))
        ...
        $this->assertEquals(AdapterInterface::Apartment_TYPE_ENUM, $enumColumn->getType());
    ...
    {
        $tableQuoted = new \Apartment\Db\Table('group', [], $this->adapter);
