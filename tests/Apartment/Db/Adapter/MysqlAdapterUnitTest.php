...
use Apartment\Db\Adapter\MysqlAdapter;
...
class MysqlAdapterUnitTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        if (!TESTS_Apartment_DB_ADAPTER_MYSQL_ENABLED) {
            $this->markTestSkipped('Mysql tests disabled. See TESTS_Apartment_DB_ADAPTER_MYSQL_ENABLED constant.');
        }
    ...
    {
        $column1 = $this->getMockBuilder('Apartment\Db\Table\Column')
                      ->disableOriginalConstructor()
        ...
        $column2 = $this->getMockBuilder('Apartment\Db\Table\Column')
                      ->disableOriginalConstructor()
                      ->setMethods([ 'getName', 'getAfter', 'getType', 'getLimit', 'setLimit'])
                      ->getMock();
        ...
        $table = $this->getMockBuilder('Apartment\Db\Table')
                      ->disableOriginalConstructor()
    ...
    {
        $refTable = $this->getMockBuilder('Apartment\Db\Table')
                      ->disableOriginalConstructor()
                      ->setMethods(['getName', 'getOptions', 'getPendingColumns', 'getIndexes', 'getForeignKeys'])
                      ->getMock();
        ...
        $column3 = $this->getMockBuilder('Apartment\Db\Table\Column')
                      ->disableOriginalConstructor()
                      ->setMethods([ 'getName', 'getAfter', 'getType', 'getLimit', 'setLimit'])
                      ->getMock();
        ...
        $index = $this->getMockBuilder('Apartment\Db\Table\Index')
                      ->disableOriginalConstructor()
        ...
        $foreignkey = $this->getMockBuilder('Apartment\Db\Table\ForeignKey')
                           ->disableOriginalConstructor()
                           ->setMethods([ 'getColumns',
                                               'getConstraint',
    ...
    public function testGetColumns()
    {
        ...
        $this->assertInstanceOf('Apartment\Db\Table\Column', $columns[0]);
        ...
        $this->assertInstanceOf('Apartment\Db\Table\Column', $columns[1]);
    ...
    {
        $column = $this->getMockBuilder('Apartment\Db\Table\Column')
                      ->disableOriginalConstructor()
    ...
    public function testGetSqlTypeExists()
    {
        $this->assertEquals(
            ...
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_STRING)
        );
        $this->assertEquals(
            ['name' => 'char', 'limit' => 255],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_CHAR, 255)
        );

        //text combinations
        $this->assertEquals(
            ['name' => 'text'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TEXT)
        );
        $this->assertEquals(
            ['name' => 'tinytext'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TEXT, MysqlAdapter::TEXT_TINY)
        );
        $this->assertEquals(
            ['name' => 'tinytext'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TEXT, MysqlAdapter::TEXT_TINY + 1)
        );
        $this->assertEquals(
            ['name' => 'text'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TEXT, MysqlAdapter::TEXT_REGULAR)
        );
        $this->assertEquals(
            ['name' => 'text'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TEXT, MysqlAdapter::TEXT_REGULAR + 1)
        );
        $this->assertEquals(
            ['name' => 'mediumtext'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TEXT, MysqlAdapter::TEXT_MEDIUM)
        );
        $this->assertEquals(
            ['name' => 'mediumtext'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TEXT, MysqlAdapter::TEXT_MEDIUM + 1)
        );
        $this->assertEquals(
            ['name' => 'longtext'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TEXT, MysqlAdapter::TEXT_LONG)
        );
        $this->assertEquals(
            ['name' => 'longtext'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TEXT, MysqlAdapter::TEXT_LONG + 1)
        );

        //blob combinations
        $this->assertEquals(
            ['name' => 'blob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB)
        );
        $this->assertEquals(
            ['name' => 'tinyblob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB, MysqlAdapter::BLOB_TINY)
        );
        $this->assertEquals(
            ['name' => 'tinyblob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB, MysqlAdapter::BLOB_TINY + 1)
        );
        $this->assertEquals(
            ['name' => 'blob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB, MysqlAdapter::BLOB_REGULAR)
        );
        $this->assertEquals(
            ['name' => 'blob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB, MysqlAdapter::BLOB_REGULAR + 1)
        );
        $this->assertEquals(
            ['name' => 'mediumblob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB, MysqlAdapter::BLOB_MEDIUM)
        );
        $this->assertEquals(
            ['name' => 'mediumblob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB, MysqlAdapter::BLOB_MEDIUM + 1)
        );
        $this->assertEquals(
            ['name' => 'longblob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB, MysqlAdapter::BLOB_LONG)
        );
        $this->assertEquals(
            ['name' => 'longblob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB, MysqlAdapter::BLOB_LONG + 1)
        );

        $this->assertEquals(
            ['name' => 'binary', 'limit' => 255],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BINARY)
        );
        $this->assertEquals(
            ['name' => 'binary', 'limit' => 36],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BINARY, 36)
        );

        $this->assertEquals(
            ['name' => 'varbinary', 'limit' => 255],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_VARBINARY)
        );
        $this->assertEquals(
            ['name' => 'varbinary', 'limit' => 16],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_VARBINARY, 16)
        );

        //int combinations
        $this->assertEquals(
            ['name' => 'int', 'limit' => 11],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER)
        );
        $this->assertEquals(
            ['name' => 'bigint', 'limit' => 20],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BIG_INTEGER)
        );
        $this->assertEquals(
            ['name' => 'tinyint'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_TINY)
        );
        $this->assertEquals(
            ['name' => 'tinyint'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_TINY + 1)
        );
        $this->assertEquals(
            ['name' => 'smallint'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_SMALL)
        );
        $this->assertEquals(
            ['name' => 'smallint'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_SMALL + 1)
        );
        $this->assertEquals(
            ['name' => 'mediumint'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_MEDIUM)
        );
        $this->assertEquals(
            ['name' => 'mediumint'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_MEDIUM + 1)
        );
        $this->assertEquals(
            ['name' => 'int', 'limit' => 11],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_REGULAR)
        );
        $this->assertEquals(
            ['name' => 'int', 'limit' => 11],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_REGULAR + 1)
        );
        $this->assertEquals(
            ['name' => 'bigint', 'limit' => 20],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_BIG)
        );
        $this->assertEquals(
            ['name' => 'bigint', 'limit' => 20],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_INTEGER, MysqlAdapter::INT_BIG + 1)
        );

        $this->assertEquals(
            ['name' => 'float'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_FLOAT)
        );
        $this->assertEquals(
            ['name' => 'decimal'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_DECIMAL)
        );
        $this->assertEquals(
            ['name' => 'datetime'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_DATETIME)
        );
        $this->assertEquals(
            ['name' => 'timestamp'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TIMESTAMP)
        );
        $this->assertEquals(
            ['name' => 'date'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_DATE)
        );
        $this->assertEquals(
            ['name' => 'time'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_TIME)
        );
        $this->assertEquals(
            ['name' => 'blob'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BLOB)
        ...
        $this->assertEquals(
            ...
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_BOOLEAN)
        );
        $this->assertEquals(
            ['name' => 'geometry'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_GEOMETRY)
        );
        $this->assertEquals(
            ['name' => 'linestring'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_LINESTRING)
        );
        $this->assertEquals(
            ['name' => 'point'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_POINT)
        );
        $this->assertEquals(
            ['name' => 'polygon'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_POLYGON)
        );
        $this->assertEquals(
            ['name' => 'enum'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_ENUM)
        );
        $this->assertEquals(
            ['name' => 'set'],
            $this->adapter->getSqlType(MysqlAdapter::Apartment_TYPE_SET)
        );
    }
    ...
    public function testApartmentTypeExistsWithoutLimit()
    {
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_STRING, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('varchar')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_CHAR, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('char')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_INTEGER, 'limit' => MysqlAdapter::INT_TINY, 'precision' => null],
            $this->adapter->getApartmentType('tinyint')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_INTEGER, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('int')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_INTEGER, 'limit' => MysqlAdapter::INT_SMALL, 'precision' => null],
            $this->adapter->getApartmentType('smallint')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_INTEGER, 'limit' => MysqlAdapter::INT_MEDIUM, 'precision' => null],
            $this->adapter->getApartmentType('mediumint')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BIG_INTEGER, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('bigint')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BINARY, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('blob')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_VARBINARY, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('varbinary')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_FLOAT, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('float')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_DECIMAL, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('decimal')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_DATETIME, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('datetime')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_TIMESTAMP, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('timestamp')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_DATE, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('date')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_TIME, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('time')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_TEXT, 'limit' => MysqlAdapter::TEXT_TINY, 'precision' => null],
            $this->adapter->getApartmentType('tinytext')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_TEXT, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('text')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_TEXT, 'limit' => MysqlAdapter::TEXT_MEDIUM, 'precision' => null],
            $this->adapter->getApartmentType('mediumtext')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_TEXT, 'limit' => MysqlAdapter::TEXT_LONG, 'precision' => null],
            $this->adapter->getApartmentType('longtext')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BINARY, 'limit' => MysqlAdapter::BLOB_TINY, 'precision' => null],
            $this->adapter->getApartmentType('tinyblob')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BINARY, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('blob')
        ...
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BINARY, 'limit' => MysqlAdapter::BLOB_MEDIUM, 'precision' => null],
            $this->adapter->getApartmentType('mediumblob')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BINARY, 'limit' => MysqlAdapter::BLOB_LONG, 'precision' => null],
            $this->adapter->getApartmentType('longblob')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_POINT, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('point')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_GEOMETRY, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('geometry')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_LINESTRING, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('linestring')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_POLYGON, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('polygon')
        );
    }

    public function testApartmentTypeExistsWithLimit()
    {
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_STRING, 'limit' => 32, 'precision' => null],
            $this->adapter->getApartmentType('varchar(32)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_CHAR, 'limit' => 32, 'precision' => null],
            $this->adapter->getApartmentType('char(32)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_INTEGER, 'limit' => 12, 'precision' => null],
            $this->adapter->getApartmentType('int(12)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BIG_INTEGER, 'limit' => 21, 'precision' => null],
            $this->adapter->getApartmentType('bigint(21)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BINARY, 'limit' => 1024, 'precision' => null],
            $this->adapter->getApartmentType('blob(1024)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_VARBINARY, 'limit' => 16, 'precision' => null],
            $this->adapter->getApartmentType('varbinary(16)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_FLOAT, 'limit' => 8, 'precision' => 2],
            $this->adapter->getApartmentType('float(8,2)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_DECIMAL, 'limit' => 8, 'precision' => 2],
            $this->adapter->getApartmentType('decimal(8,2)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_TEXT, 'limit' => 1024, 'precision' => null],
            $this->adapter->getApartmentType('text(1024)')
        );
    }

    public function testApartmentTypeExistsWithLimitNull()
    {
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_STRING, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('varchar(255)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_CHAR, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('char(255)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_INTEGER, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('int(11)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BIG_INTEGER, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('bigint(20)')
        );
        $this->assertEquals(
            ['name' => MysqlAdapter::Apartment_TYPE_BOOLEAN, 'limit' => null, 'precision' => null],
            $this->adapter->getApartmentType('tinyint(1)')
        );
    }

    public function testApartmentTypeNotValidType()
    {
        $this->setExpectedException('\RuntimeException', 'The type: "fake" is not supported.');
        $this->adapter->getApartmentType('fake');
    }

    public function testApartmentTypeNotValidTypeRegex()
    {
    ...
    public function testGetIndexSqlDefinitionRegular()
    {
        ...
        $index->expects($this->any())->method('getType')->will($this->returnValue(\Apartment\Db\Table\Index::INDEX));
    ...
    public function testGetIndexSqlDefinitionUnique()
    {
        ...
        $index->expects($this->any())->method('getColumns')->will($this->returnValue(['column_name']));
        $index->expects($this->any())->method('getName')->will($this->returnValue('index_name'));
        $index->expects($this->any())->method('getType')->will($this->returnValue(\Apartment\Db\Table\Index::UNIQUE));
