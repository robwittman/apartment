...
use Apartment\Db\Adapter\SqlServerAdapter;
...
{
    /**
     * @var \Apartment\Db\Adapter\SqlServerAdapter
     */
    private $adapter;

    public function setUp()
    {
        if (!TESTS_Apartment_DB_ADAPTER_SQLSRV_ENABLED) {
            $this->markTestSkipped('SqlServer tests disabled. See TESTS_Apartment_DB_ADAPTER_SQLSRV_ENABLED constant.');
        }

        $options = [
            'host' => TESTS_Apartment_DB_ADAPTER_SQLSRV_HOST,
            'name' => TESTS_Apartment_DB_ADAPTER_SQLSRV_DATABASE,
            'user' => TESTS_Apartment_DB_ADAPTER_SQLSRV_USERNAME,
            'pass' => TESTS_Apartment_DB_ADAPTER_SQLSRV_PASSWORD,
            'port' => TESTS_Apartment_DB_ADAPTER_SQLSRV_PORT
        ];
    ...
    public function testHasDatabase()
    {
        ...
        $this->assertTrue($this->adapter->hasDatabase(TESTS_Apartment_DB_ADAPTER_SQLSRV_DATABASE));
    }
    ...
    public function testGetApartmentType()
    {
        ...
        $this->assertEquals('boolean', $this->adapter->getApartmentType('bit'));

        $this->assertEquals('string', $this->adapter->getApartmentType('varchar'));
        $this->assertEquals('string', $this->adapter->getApartmentType('nvarchar'));
        $this->assertEquals('char', $this->adapter->getApartmentType('char'));
        $this->assertEquals('char', $this->adapter->getApartmentType('nchar'));
        ...
        $this->assertEquals('date', $this->adapter->getApartmentType('date'));

        $this->assertEquals('datetime', $this->adapter->getApartmentType('datetime'));
    }
