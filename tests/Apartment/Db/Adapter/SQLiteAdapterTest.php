...
use Apartment\Db\Adapter\SQLiteAdapter;
...
{
    /**
     * @var \Apartment\Db\Adapter\SQLiteAdapter
     */
    private $adapter;

    public function setUp()
    {
        if (!TESTS_Apartment_DB_ADAPTER_SQLITE_ENABLED) {
            $this->markTestSkipped('SQLite tests disabled. See TESTS_Apartment_DB_ADAPTER_SQLITE_ENABLED constant.');
        }

        $options = [
            'name' => TESTS_Apartment_DB_ADAPTER_SQLITE_DATABASE
        ];
    ...
    public function testChangeColumnWithForeignKey()
    {
        ...
        $table = new \Apartment\Db\Table('another_table', [], $this->adapter);
    ...
    public function testDropForeignKey()
    {
        ...
        $secondFk = new \Apartment\Db\Table\ForeignKey();
    ...
    public function testHasDatabase()
    {
        ...
        $this->assertTrue($this->adapter->hasDatabase(TESTS_Apartment_DB_ADAPTER_SQLITE_DATABASE));
    }
