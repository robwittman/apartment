...
use Apartment\Console\Command\Create;
...
/**
 * Class CreateTest
 * @package Test\Apartment\Console\Command
 * @group create
 */
class CreateTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function provideFailingTemplateGenerator()
    {
        return [
            [
                [
                    'templates' => [
                        'class' => '\Test\Apartment\Console\Command\TemplateGenerators\DoesNotImplementRequiredInterface',
                    ],
                ],
                [],
                'The class "\Test\Apartment\Console\Command\TemplateGenerators\DoesNotImplementRequiredInterface" does not implement the required interface "Apartment\Migration\CreationInterface"',
            ],
            [
                [],
                ['--class' => '\Test\Apartment\Console\Command\TemplateGenerators\DoesNotImplementRequiredInterface'],
            ...
            [
                [
                    'aliases' => [
                        'PoorInterface' => '\Test\Apartment\Console\Command\TemplateGenerators\DoesNotImplementRequiredInterface',
                    ],
                ],
                [
                    '--class' => 'PoorInterface',
                ],
                'The class "\Test\Apartment\Console\Command\TemplateGenerators\DoesNotImplementRequiredInterface" via the alias "PoorInterface" does not implement the required interface "Apartment\Migration\CreationInterface"',
            ],
        ];
    }
    ...
    public function provideNullTemplateGenerator()
    {
        return [
            [
                [
                    'templates' => [
                        'class' => '\Test\Apartment\Console\Command\TemplateGenerators\NullGenerator',
                    ],
                ],
                ['name' => 'Null1'],
            ],
            ...
            [
                [
                    'aliases' => [
                        'NullGen' => '\Test\Apartment\Console\Command\TemplateGenerators\NullGenerator',
                    ],
                ],
                [
                    'name' => 'Null3',
    ...
    public function provideSimpleTemplateGenerator()
    {
        return [
            [
                [
                    'templates' => [
                        'class' => '\Test\Apartment\Console\Command\TemplateGenerators\SimpleGenerator',
                    ],
                ],
                ['name' => 'Simple1'],
            ],
            ...
            [
                [
                    'aliases' => [
                        'SimpleGen' => '\Test\Apartment\Console\Command\TemplateGenerators\SimpleGenerator',
                    ],
                ],
                [
                    'name' => 'Simple3',
    ...
    public function testSimpleTemplateGeneratorsIsCorrectlyPopulated(array $config, array $commandLine)
    {
        ...
        $expectedMigration = "useClassName Apartment\\Migration\\AbstractMigration / className {$commandLine['name']} / version {$match['Version']} / baseClassName AbstractMigration";
