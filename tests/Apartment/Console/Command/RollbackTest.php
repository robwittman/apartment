...
use Apartment\Console\Command\Rollback;
...
class RollbackTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $application = new \Apartment\Console\ApartmentApplication('testing');
        $application->add(new Rollback());
    ...
    public function testWithDate()
    {
        ...
        $rollbackStub = $this->getMockBuilder('\Apartment\Console\Command\Rollback')
